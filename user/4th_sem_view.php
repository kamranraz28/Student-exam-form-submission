...
<body>
    ...
    <div class="wrapper">
        ...
        ?>
            ...
            <br>
            <div class="admit_btn" style="margin-left: 79%;">
                <a href="download/download_4th.php"><button class="btn btn-danger"><i class="fas fa-download"></i> Admit Download</button></a>
            </div>
