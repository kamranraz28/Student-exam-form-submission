...
<body>
    ...
    <div class="wrapper">
        ...
        ?>
            ...
            <br>
            <div class="admit_btn" style="margin-left: 68%;">
                <a href="download/download_8th.php"><button class="btn btn-danger"><i class="fas fa-download"></i> Admit Download</button></a>
            </div>
