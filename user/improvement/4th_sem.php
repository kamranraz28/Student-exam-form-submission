...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="forms">
            <form class="myform" method="POST" action="improvement/4th_sem_check.php">
                <table width="100%">
                    <tr>
                    <th>Select</th>
                    <th> Subject name</th>
                    ...
                    <tr style='color:black;font-size:18px;'>
                        <td><input type='checkbox' class='geekmark' value="<?php echo $row['sub_name'];?>" name="sublist[]"/></td>
