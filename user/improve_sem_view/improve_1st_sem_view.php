...
<body>
    ...
    <div class="wrapper">
        ...
        ?>
            <h1 class="myh1">Improvement Subject Computer Science & Engineering</h1>
            <div class="forms">
            ...
            <br>
            <div class="admit_btn" style="margin-left: 64%;">
                <a href="../download/download_1st_improve.php"><button class="btn btn-danger"><i class="fas fa-download"></i> Admit Download</button></a>
            </div>
