...
<body>
    ...
    <div class="wrapper">
        ...
        ?>
            ...
            <br>
            <div class="admit_btn" style="margin-left: 67%;">
                <a href="download/download_2nd.php"><button class="btn btn-danger"><i class="fas fa-download"></i> Admit Download</button></a>
            </div>
